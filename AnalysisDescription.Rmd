...
library(data.table)
library(rdrop2)
# Next three lines below should only be run for the first time you run the script 
# (still have to check if need to be re-run after turning off the computer or smth).
# drop_auth()
# token <- drop_auth()
