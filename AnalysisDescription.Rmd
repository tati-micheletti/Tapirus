...
# These below are still not ready. When I have all p.values, I need to make posthocs on ANOVAS and K-Ws as a NEW data.table (maybe subset those?). This table needs to have the means so we know who is smaller than who. I need to filter the variables which p.value < 0.05 and these can't go to the sex comparison. 
