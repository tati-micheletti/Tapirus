...
source(file.path(getwd(),"R functions/naOmitList.R"))
...
source(file.path(getwd(),"R functions/checkComparison.R"))

compSEX <- checkComparison(comparisonGroup = "SEX", tableList = tableList, biome = biome, sex = sex)
compBIOME <- checkComparison(comparisonGroup = "BIOME", biomeTable = biomeTable, tableList = tableList, biome = biome, sex = sex)
```
...
source(file.path(getwd(),"R functions/createTestsTable.R"))
...
source(file.path(getwd(),"R functions/mergeLastTables.R"))
